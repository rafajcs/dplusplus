...
public final class ASimplesExpressaoRelacional extends PExpressaoRelacional
{
    private PExpressaoAritmetica _expressaoAritmetica_;

    public ASimplesExpressaoRelacional()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASimplesExpressaoRelacional(
    ...
    {
        ((Analysis) sw).caseASimplesExpressaoRelacional(this);
    }
