...
public final class ASubtracaoExpressao extends PExpressao
{
    private PExpressao _esq_;
    private PExpressao _dir_;

    public ASubtracaoExpressao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASubtracaoExpressao(
    ...
    {
        ((Analysis) sw).caseASubtracaoExpressao(this);
    }
