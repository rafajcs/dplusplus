...
public final class AClasseDefinicaoCorpo extends PDefinicaoCorpo
{
    private PDeclaracaoClasse _declaracaoClasse_;

    public AClasseDefinicaoCorpo()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AClasseDefinicaoCorpo(
    ...
    {
        ((Analysis) sw).caseAClasseDefinicaoCorpo(this);
    }
