...
public final class ASimplesExpressaoAnd extends PExpressaoAnd
{
    private PExpressaoRelacional _expressaoRelacional_;

    public ASimplesExpressaoAnd()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASimplesExpressaoAnd(
    ...
    {
        ((Analysis) sw).caseASimplesExpressaoAnd(this);
    }
